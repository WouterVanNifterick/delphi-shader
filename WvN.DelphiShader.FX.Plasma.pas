...
begin
  mov0   := gl_FragCoord.x + gl_FragCoord.y + System.cos(sinLarge(iGlobalTime) * 2) * 100. + System.sin(gl_FragCoord.x / 100) * 1000;
  ...
  c2     := System.abs(System.sin(c1 + sinLarge(mov0 / 1000 + iGlobalTime) + System.sin(gl_FragCoord.y / 40 + iGlobalTime) + System.sin((gl_FragCoord.x + gl_FragCoord.y) / 100) * 3));
  c3     := System.abs(System.sin(c2 + cosLarge(mov1 + mov2 + c2) + System.cos(mov2) + System.sin(gl_FragCoord.x / 1000)));
